//Generating File After Porter with total frequency
#include<iostream>
#include<ctype.h>
#include<vector>
#include<cstring>
...
#define TRUE 1
#define FALSE 0
FILE *fptr=fopen("/home/livingroom/DC/output_files/Step1_final.txt","w");
...
{  int i;
   ...
   for (i = 1; i < 2; i++)
   {  FILE * f = fopen("/home/livingroom/DC/output_files/Step1.txt","r");  
